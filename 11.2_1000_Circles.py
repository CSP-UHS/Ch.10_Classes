...
class Circle():
    def __init__(self):
        self.r = random.randint(5, 110)
        self.x = random.randint(self.r, sw-self.r)
        self.y = random.randint(self.r, sh-self.r)
        self.clr = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))

    def draw_circle(self):
        arcade.draw_circle_outline(self.x, self.y, self.r, self.clr, 5)
