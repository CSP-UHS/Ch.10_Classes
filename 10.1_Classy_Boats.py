...
3.) The name should be entered as an argument when the object is created. text string
4.) The isDocked attribute is a Boolean variable. Set it to True. (isDocked? TRUE or false)
5.) Add a method called dock( )
6.) In this method, if the boat is already docked print "(boat name) is already docked."  if else
7.) If it is not docked, print "(boat name) is docking" and set the isDocked attribute to True. if else
